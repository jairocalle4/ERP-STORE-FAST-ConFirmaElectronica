...
namespace ElectronicBilling.Infrastructure.Pdf;
                ...
                page.Header().Element(headerContainer =>
                {
                    headerContainer.Row(row =>
                    {
                        ...
                        row.RelativeItem(5).Border(1).BorderColor(Colors.Grey.Lighten1).Padding(10).Column(col =>
                        {
                            ...
                            col.Item().Text($"AMBIENTE: {(issuer.Environment == Core.Enums.SriEnvironment.Production ? "PRODUCCIÓN" : "PRUEBAS")}").FontSize(8);
                ...
                page.Content().PaddingVertical(10).Column(col =>
                {
                    ...
                    col.Item().Row(r =>
                    {
                        ...
                        r.RelativeItem(4).Table(ttable =>
                        {
                            ...
                            AddTotalRow(ttable, "SUBTOTAL 15%", subtotalWithoutTax.ToString("F2"));
                            AddTotalRow(ttable, "SUBTOTAL 0%", "0.00");
                            ...
                            AddTotalRow(ttable, "IVA 15%", totalTax.ToString("F2"));
...
{
    public static TextStyle Apply(this TextStyle style, Func<TextStyle, TextStyle> action) => action(style);
}
