...
namespace ErpStore.Infrastructure.Migrations
{
    ...
    [Migration("20260812213000_AddWithdrawalAmountToCashRegisterSession")]
    partial class AddWithdrawalAmountToCashRegisterSession
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ErpStore.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Permissions = "[\"dashboard\",\"catalog\",\"sales\",\"pos\",\"clients\",\"inventory\",\"employees\",\"expenses\",\"reports\",\"settings\",\"cash_register\",\"purchases\",\"notifications\"]",
                            Role = 1,
                            Username = "jairo.ceo"
                        });
                });
            ...
            modelBuilder.Entity("ErpStore.Domain.Entities.Expense", b =>
                {
                    b.HasOne("ErpStore.Domain.Entities.CashRegisterSession", null)
                        .WithMany()
                        .HasForeignKey("CashRegisterSessionId");
            ...
            modelBuilder.Entity("ErpStore.Domain.Entities.InventoryMovement", b =>
                {
                    ...
                    b.HasOne("ErpStore.Domain.Entities.Purchase", null)
                        .WithMany()
                        .HasForeignKey("PurchaseId");

                    b.HasOne("ErpStore.Domain.Entities.Sale", null)
                        .WithMany()
